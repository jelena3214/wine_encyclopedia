...
class ViewTest(TestCase):
    ...
    def test_detours(self):
        ...
        slika = createPicture(offer)
        detourType = createDetourType("Profi Obilazak",1700,"Obilazak je veoma profi hladni smo ko led zestoki ko dzek",detour)
    ...
    def test_detour_specific(self):
        ...
        detourtype = createDetourType("Profi Obilazak", 1700,
                                      "Obilazak je veoma profi hladni smo ko led zestoki ko dzek", detour)
    ...
    def test_celebrations(self):
        ...
        offer = createOffer(user)
        offerspace = createOfferSpace(offer)
        proslava = createCelebration(offerspace, "opis mnogo super proslave Tasha volimo te", 1700, 100)
        slika = createPicture(offer)
    ...
    def test_celebration_specific(self):
        ...
        self.assertContains(response,"opis mnogo super proslave Tasha volimo te",html=True)
