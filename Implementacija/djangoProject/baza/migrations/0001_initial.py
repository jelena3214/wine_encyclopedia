    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('javnoime', models.CharField(blank=True, db_column='javnoIme', max_length=200, null=True)),
        ...
        migrations.CreateModel(
            name='Ponuda',
            fields=[
                ('idponuda', models.AutoField(db_column='idPonuda', primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            name='Pretplata',
            fields=[
                ('idpretplata', models.AutoField(db_column='idPretplata', primary_key=True, serialize=False)),
                ('naslov', models.CharField(blank=True, max_length=200, null=True)),
        ...
        migrations.CreateModel(
            name='Upitnikpitanje',
            fields=[
                ('idpitanje', models.AutoField(db_column='idPitanje', primary_key=True, serialize=False)),
                ('tekst', models.CharField(blank=True, max_length=100, null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('korisnik_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to=settings.AUTH_USER_MODEL)),
                ('imefirme', models.CharField(blank=True, db_column='imeFirme', max_length=200, null=True)),
        ...
        migrations.CreateModel(
            name='Upitnikodgovor',
            fields=[
                ('idodgovor', models.AutoField(db_column='idOdgovor', primary_key=True, serialize=False)),
                ('odgovor', models.CharField(blank=True, max_length=100, null=True)),
        ...
        migrations.CreateModel(
            name='Recenzija',
            fields=[
                ('idrecenzija', models.AutoField(db_column='idRecenzija', primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            name='Ukorpi',
            fields=[
                ('idkorpa', models.AutoField(db_column='idKorpa', primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            name='Termin',
            fields=[
                ('idtermin', models.AutoField(db_column='idTermin', primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            name='Vrstaobilaska',
            fields=[
                ('idobilazak', models.AutoField(db_column='idObilazak', primary_key=True, serialize=False)),
                ('naziv', models.CharField(blank=True, max_length=100, null=True)),
                ('cena', models.IntegerField(blank=True, null=True)),
                ('opis', models.TextField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            name='Somelijer',
            fields=[
                ('idsomelijer', models.AutoField(db_column='idSomelijer', primary_key=True, serialize=False)),
